# Firmware to flash internal ExpressLRS modules
...
The code supports following handsets running [EdgeTX](https://edgetx.org/) (compatible radios listed alphabetically):
